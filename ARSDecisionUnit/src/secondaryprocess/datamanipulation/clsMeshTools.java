 ...
 * (wendt)
 * 
 * @author wendt 22.05.2012, 13:01:07
 * 
 */
public class clsMeshTools
{
    ...
    // private static final clsThingPresentationMesh moNullObjectTPM = clsDataStructureGenerator.generateTPM(new
    // clsTriple<eContentType, ArrayList<clsThingPresentation>, Object>(eContentType.NULLOBJECT, new
    // ArrayList<clsThingPresentation>(), eContentType.NULLOBJECT.toString()));
    // private static final clsWordPresentationMesh moNullObjectWPM = clsDataStructureGenerator.generateWPM(new
    // clsPair<eContentType, Object>(eContentType.NULLOBJECT, eContentType.NULLOBJECT.toString()), new
    // ArrayList<clsAssociation>());
    ...
    {
        return clsDataStructureGenerator.generateTPM(new clsTriple<eContentType, ArrayList<clsThingPresentation>, Object>(eContentType.NULLOBJECT,
                new ArrayList<clsThingPresentation>(), eContentType.NULLOBJECT.toString()));// moNullObjectTPM;
    }
    ...
    {
        return clsDataStructureGenerator.generateWPM(new clsPair<eContentType, Object>(eContentType.NULLOBJECT, eContentType.NULLOBJECT.toString()),
                new ArrayList<clsAssociation>());// moNullObjectWPM;
    }
     ...
     * @return
     */
    public static <E extends clsDataStructurePA> E searchPADataStructureInArrayList(
            ArrayList<E> poList, E poSearchDS
            )
    {
        E oRetVal = null;
    ...
    /**
     * Get all TPM structures in a mesh up to a certain level. A list with each TPM structure is returned (wendt)
     *
     * @since 05.01.2012 10:42:02
     *
     * @param poMesh:
     *            The ThingPresentationMesh, normally the perception
     * @param poDataType:
     *            Filter: Returndatatype: TPM, TP or DM
     * @param poContentType:
     *            Filter ContentType. Set null for no filter
     * @param poContent:
     *            Filter Content. Set null for no filter
     * @param pbStopAtFirstMatch:
     *            Break at first match
     * @param pnLevel:
     *            Level of search depth. If = 1, only the current image is processed. If pnLevel = 2, all direct matches
     *            to the top image are processed
     * @return
     */
    public static ArrayList<clsDataStructurePA> getDataStructureInTPM(
            clsThingPresentationMesh poMesh, eDataType poDataType, ArrayList<eContentType> poContentTypeList, boolean pbStopAtFirstMatch, int pnLevel
            )
    {
     ...
     * @return
     */
    public static clsDataStructurePA getFirstDataStructureInTPM(
            clsThingPresentationMesh poMesh, eDataType poDataType, ArrayList<eContentType> poContentTypeList, int pnLevel
            )
    {
    ...
    /**
     * Recursively go through all elements in the mesh to get all TPMs, but here, this function is only used if there
     * already exists a list
     * 
     * (wendt)
     *
     ...
     * @return
     */
    private static void searchDataStructureInTPM(
            clsThingPresentationMesh poMesh, ArrayList<clsThingPresentationMesh> poAddedElements, ArrayList<clsDataStructurePA> poRetVal, eDataType poDataType,
            ArrayList<eContentType> poContentTypeFilterList, boolean pbStopAtFirstMatch, int pnLevel
            )
    {
        ...
        if (pbStopAtFirstMatch == false || poRetVal.isEmpty() == true)
        { // =NOT Stopatfirstmatch=true AND oRetVal is not empty
            ...
            if ((pnLevel > 0) || (pnLevel == -1))
            {
                for (clsAssociation oAss : poMesh.getInternalAssociatedContent())
                {
                    ...
                    {
                        searchDataStructureInTPM((clsThingPresentationMesh) oAss.getLeafElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeFilterList, pbStopAtFirstMatch, pnLevel - 1);
                    }
                    else if (poAddedElements.contains(oAss.getRootElement()) == false && oAss.getRootElement() instanceof clsThingPresentationMesh)
                    {
                        searchDataStructureInTPM((clsThingPresentationMesh) oAss.getRootElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeFilterList, pbStopAtFirstMatch, pnLevel - 1);
                    }
                }
            }
            ...
            if ((pnLevel > 1) || (pnLevel == -1))
            {
                for (clsAssociation oExtAss : poMesh.getExternalAssociatedContent())
                {
                    ...
                    {
                        searchDataStructureInTPM((clsThingPresentationMesh) oExtAss.getLeafElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeFilterList, pbStopAtFirstMatch, pnLevel - 1);
                    }
                    else if (poAddedElements.contains(oExtAss.getRootElement()) == false && oExtAss.getRootElement() instanceof clsThingPresentationMesh)
                    {
                        searchDataStructureInTPM((clsThingPresentationMesh) oExtAss.getRootElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeFilterList, pbStopAtFirstMatch, pnLevel - 1);
                    }
                }
            }
     ...
     * @return
     */
    private static boolean filterTPM(
            clsThingPresentationMesh poMesh, eContentType poContentType
            )
    {
     ...
     * @return
     */
    private static ArrayList<clsAssociationDriveMesh> getDMAssociations(
            clsThingPresentationMesh poTPM, ArrayList<eContentType> poContentTypeFilterList, boolean pbStopAtFirstMatch
        )
    {
        ...
        else
        {
            for (eContentType oCTC : poContentTypeFilterList)
            {
                ...
                if (pbStopAtFirstMatch == false || oRetVal.isEmpty() == true)
                {
                    ...
                    // oRetVal.addAll(FilterDMList(poTPM.getExternalMoAssociatedContent(), oCTC.a, oCTC.b,
                    // pbStopAtFirstMatch));
                    break;
                }
            }
     ...
     * @return
     */
    private static ArrayList<clsAssociationEmotion> getEMOTIONAssociations(
            clsThingPresentationMesh poTPM, ArrayList<eContentType> poContentTypeFilterList, boolean pbStopAtFirstMatch
        )
    {
     ...
     * @return
     */
    private static ArrayList<clsAssociationAttribute> FilterTPList(
            ArrayList<clsAssociation> poAssList, eContentType poContentType, boolean pbStopAtFirstMatch
        )
    {
     ...
     * @return
     */
    private static ArrayList<clsAssociationDriveMesh> FilterDMList(
            ArrayList<clsAssociation> poAssList, eContentType poContentType, boolean pbStopAtFirstMatch
                )
    {
        ArrayList<clsAssociationDriveMesh> oRetVal = new ArrayList<clsAssociationDriveMesh>();
     ...
     * @return
     */
    private static ArrayList<clsAssociationEmotion> FilterEMOTIONList(
            ArrayList<clsAssociation> poAssList, eContentType poContentType, boolean pbStopAtFirstMatch
                )
    {
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> searchDataStructureTypesInMesh(
            clsThingPresentationMesh poTargetImageMesh, clsThingPresentationMesh poFindDataStructure, int pnLevel
            )
    {
        ArrayList<clsThingPresentationMesh> oRetVal = new ArrayList<clsThingPresentationMesh>();
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> searchDataStructureInstanceInImageTPM(
            clsThingPresentationMesh poTargetImageMesh, clsThingPresentationMesh poFindDataStructure, int pnLevel, boolean pbUseTypeID,
            boolean pbStopAtFirstMatch
            )
    {
        ArrayList<clsThingPresentationMesh> oRetVal = new ArrayList<clsThingPresentationMesh>();
        // Compare IDs of the structures
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> searchDataStructureInstanceInTPM(
            clsThingPresentationMesh poTargetImageMesh, clsThingPresentationMesh poFindDataStructure, int pnLevel, boolean pbUseTypeID,
            boolean pbStopAtFirstMatch
            )
    {
     ...
     * @return
     */
    public static clsThingPresentationMesh searchFirstDataStructureInstanceInTPM(
            clsThingPresentationMesh poTargetImageMesh, clsThingPresentationMesh poFindDataStructure, int pnLevel, boolean pbUseTypeID
            )
    {
        ...
        ArrayList<clsThingPresentationMesh> oAllTPMInMesh = clsMeshTools.searchDataStructureInstanceInTPM(poTargetImageMesh, poFindDataStructure, pnLevel,
                pbUseTypeID, true);
     ...
     * @return
     */
    public static clsThingPresentationMesh searchFirstDataStructureInstanceInImageTPM(
            clsThingPresentationMesh poTargetImageMesh, clsThingPresentationMesh poFindDataStructure, int pnLevel, boolean pbUseTypeID
            )
    {
        clsThingPresentationMesh oRetVal = clsMeshTools.getNullObjectTPM();
        ...
        ArrayList<clsThingPresentationMesh> oAllTPMInMesh = clsMeshTools.searchDataStructureInstanceInImageTPM(poTargetImageMesh, poFindDataStructure, pnLevel,
                pbUseTypeID, true);
     ...
     * @param poContentType:
     *            Content type of the searched structure
     * @param pnMode:
     *            0 = get the contenttype of the OTHER association as this element; 1 = get the contenttype of the ROOT
     *            element; 2 = get the contenttype of the LEAF element
     * @param pbGetWholeAssociation:
     *            Get the whole association and not one of the end points
     * @param pbStopAtFirstMatch:
     *            Stop at first match
     * @return
     */
    private static ArrayList<clsDataStructurePA> searchAssociationListPrimary(
            ArrayList<clsAssociation> poInputList, clsDataStructurePA poThisDataStructure, eContentType poDSContentType, int pnMode,
            boolean pbGetWholeAssociation, boolean pbStopAtFirstMatch
                )
    {
        ArrayList<clsDataStructurePA> oRetVal = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static ArrayList<clsDataStructurePA> searchDataStructureOverAssociation(
            clsThingPresentationMesh poInput, eContentType poDataStructureContentType, int pnMode, boolean pbGetWholeAssociation, boolean pbStopAtFirstMatch
        )
    {
        ArrayList<clsDataStructurePA> oRetVal = new ArrayList<clsDataStructurePA>();

        // Go through outer associations
        oRetVal.addAll(searchAssociationListPrimary(poInput.getExternalAssociatedContent(), poInput, poDataStructureContentType, pnMode, pbGetWholeAssociation,
                pbStopAtFirstMatch));

        // Go through inner associations
        oRetVal.addAll(searchAssociationListPrimary(poInput.getInternalAssociatedContent(), poInput, poDataStructureContentType, pnMode, pbGetWholeAssociation,
                pbStopAtFirstMatch));
     ...
     * @return
     */
    public static clsDataStructurePA searchFirstDataStructureOverAssociationTPM(
            clsThingPresentationMesh poInput, eContentType poDataStructureContentType, int pnMode, boolean pbGetWholeAssociation
        )
    {
        // pnMode:
        // 0 = the other element
    ...
    /**
     * Search any association list for a certain secondary association and return the other element of the association.
     * Stop at first match is optional.
     * 
     * (wendt)
     *
     ...
     * @param poPredicate
     * @param pnMode:
     *            0 = get the other element, 1 = get the root element, 2 = get the leaf element
     * @param pbStopAtFirstMatch
     * @return
     */
    private static ArrayList<clsDataStructurePA> searchAssociationListSecondary(
            ArrayList<clsAssociation> poInputList, clsDataStructurePA poThisDataStructure, ePredicate poPredicate, int pnMode, boolean pbGetWholeAssociation,
            boolean pbStopAtFirstMatch
                )
    {
        ArrayList<clsDataStructurePA> oRetVal = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static clsDataStructurePA searchFirstDataStructureOverAssociationWPM(
            clsWordPresentationMesh poInput, ePredicate poPredicate, int pnMode, boolean pbGetWholeAssociation
    )
    {
        // pnMode:
        // 0 = the other element
    ...
    /**
     * Search a through a WPM for a certain type of associations based on the predicate. Optinal, only the first match
     * is searched
     * 
     * (wendt)
     *
     ...
     */
    public static ArrayList<clsDataStructurePA> searchDataStructureOverAssociation(
            clsWordPresentationMesh poInput, ePredicate poPredicate, int pnMode, boolean pbGetWholeAssociation, boolean pbStopAtFirstMatch
        )
    {
        ArrayList<clsDataStructurePA> oRetVal = new ArrayList<clsDataStructurePA>();

        // Go through outer associations
        oRetVal.addAll(searchAssociationListSecondary(poInput.getExternalAssociatedContent(), poInput, poPredicate, pnMode, pbGetWholeAssociation,
                pbStopAtFirstMatch));

        // Go through inner associations
        oRetVal.addAll(searchAssociationListSecondary(poInput.getInternalAssociatedContent(), poInput, poPredicate, pnMode, pbGetWholeAssociation,
                pbStopAtFirstMatch));
     ...
     * @return
     */
    public static ArrayList<clsAssociationSecondary> getAllAssociationSecondaryInMesh(
            clsWordPresentationMesh poInput, int level
                    )
    {
     ...
     * @return
     */
    public static ArrayList<clsSecondaryDataStructure> searchSecondaryDataStructureInImage(
            clsWordPresentationMesh poInput, ePredicate poPredicate, String poDataStructureContent, boolean pbStopAtFirstMatch
            )
    {
     ...
     */
    public static ArrayList<clsSecondaryDataStructure> searchSecondaryDataStructureInImage(
            clsWordPresentationMesh poInput, ePredicate poPredicate, int poID, boolean pbStopAtFirstMatch
                )
    {
        ArrayList<clsSecondaryDataStructure> oRetVal = new ArrayList<clsSecondaryDataStructure>();
     ...
     * @return
     */
    public static clsThingPresentationMesh getPrimaryDataStructureOfWPM(
            clsWordPresentationMesh poInput
    )
    {
        clsThingPresentationMesh oRetVal = clsMeshTools.getNullObjectTPM();
    ...
    /**
     * Get all WPM structures in a mesh up to a certain level. A list with each WPM structure is returned (wendt)
     *
     * @since 05.01.2012 10:42:02
     *
     * @param poMesh:
     ...
     * @return
     */
    public static ArrayList<clsDataStructurePA> getDataStructureInWPM(
            clsWordPresentationMesh poMesh, eDataType poDataType, ArrayList<clsPair<eContentType, String>> poContentTypeAndContent, boolean pbStopAtFirstMatch,
            int pnLevel
        )
    {
     ...
     * @param poMesh
     * @param poContentType:
     *            eContentType.NOTHING is equal to "" in strings
     * @param poContent
     * @return
     */
    private static boolean FilterWPM(
            clsWordPresentationMesh poMesh, eContentType poContentType, String poContent
            )
    {
        ...
        {
            if ((poContentType.equals(poMesh.getContentType()) == true) && (poContent.equals(poMesh.getContent()) == true))
            {
                oRetVal = true;
            }
        }
     ...
     * 
     * If poContent = null, then it is not a criteria (String 1) If poContentType = null, then it is not a criteria
     * (String 2)
     * 
     * pnMode 0: External and internal associations of the TPM 1: Only external associations of the TPM 2: Only internal
     * associations of the TPM
     * 
     * (wendt)
     *
     ...
     * @return
     */
    private static ArrayList<clsAssociationAttribute> getTPAssociations(
            clsThingPresentationMesh poTPM, ArrayList<eContentType> poContentTypeFilterList, boolean pbStopAtFirstMatch
                    )
    {
        ArrayList<clsAssociationAttribute> oRetVal = new ArrayList<clsAssociationAttribute>();
     ...
     * @return
     */
    private static ArrayList<clsAssociationSecondary> getWPAssociations(
            clsWordPresentationMesh poWPM, ArrayList<clsPair<eContentType, String>> poContentTypeAndContent, boolean pbStopAtFirstMatch
            )
    {
     ...
     * @return
     */
    private static ArrayList<clsAssociationSecondary> FilterWPList(
            ArrayList<clsAssociation> poAssList, eContentType poContentType, String poContent, boolean pbStopAtFirstMatch
                )
    {
        ArrayList<clsAssociationSecondary> oRetVal = new ArrayList<clsAssociationSecondary>();
     ...
     * @return
     */
    private static void searchDataStructureInWPM(
            clsWordPresentationMesh poMesh, ArrayList<clsWordPresentationMesh> poAddedElements, ArrayList<clsDataStructurePA> poRetVal, eDataType poDataType,
            ArrayList<clsPair<eContentType, String>> poContentTypeAndContent, boolean pbStopAtFirstMatch, int pnLevel
            )
    {
        // ArrayList<clsThingPresentationMesh> oRetVal = poAddedElements;
        ...
        {
            if (poMesh.getDS_ID() > -1 && poMesh.getContentType().equals(eContentType.RI) && poMesh.getDS_ID() == mesh.getDS_ID()
                    && poMesh.equals(mesh) == false)
            {
                try
                {
                    throw new Exception("Erroneous mesh structure. The element " + poMesh.getContent() + " hashcode " + poMesh.hashCode()
                            + " already exists but is not the same instance with the structure " + mesh.getContent() + " hashcode " + mesh.hashCode());
                }
                catch (Exception e)
                {
        ...
        { // =NOT Stopatfirstmatch=true AND oRetVal is not empty
            ...
            if ((pnLevel > 0) || (pnLevel == -1))
            {
                for (clsAssociation oAss : poMesh.getInternalAssociatedContent())
                {
                    if (poAddedElements.contains(oAss.getLeafElement()) == false && oAss.getLeafElement() instanceof clsWordPresentationMesh
                            && oAss.getLeafElement().equals(poMesh) == false)
                    {
                        searchDataStructureInWPM((clsWordPresentationMesh) oAss.getLeafElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeAndContent, pbStopAtFirstMatch, pnLevel - 1);
                    }
                    else if (poAddedElements.contains(oAss.getRootElement()) == false && oAss.getRootElement() instanceof clsWordPresentationMesh
                            && oAss.getRootElement().equals(poMesh) == false)
                    {
                        searchDataStructureInWPM((clsWordPresentationMesh) oAss.getRootElement(), poAddedElements, poRetVal, poDataType,
                                poContentTypeAndContent, pbStopAtFirstMatch, pnLevel - 1);
                    }
                }
            }
            ...
            if ((pnLevel > 1) || (pnLevel == -1))
            {
                for (clsAssociation oExtAss : poMesh.getExternalAssociatedContent())
                {
                    ...
                    {
                        if (poAddedElements.contains(oExtAss.getLeafElement()) == false && oExtAss.getLeafElement() instanceof clsWordPresentationMesh
                                && oExtAss.getLeafElement().equals(poMesh) == false)
                        {
                            searchDataStructureInWPM((clsWordPresentationMesh) oExtAss.getLeafElement(), poAddedElements, poRetVal, poDataType,
                                    poContentTypeAndContent, pbStopAtFirstMatch, pnLevel - 1);
                        }
                        else if (poAddedElements.contains(oExtAss.getRootElement()) == false && oExtAss.getRootElement() instanceof clsWordPresentationMesh
                                && oExtAss.getRootElement().equals(poMesh) == false)
                        {
                            searchDataStructureInWPM((clsWordPresentationMesh) oExtAss.getRootElement(), poAddedElements, poRetVal, poDataType,
                                    poContentTypeAndContent, pbStopAtFirstMatch, pnLevel - 1);
                        }
                    }
                }
    ...
    /**
     * Search a complete mesh for an instance of the search object, e.g. search for a certain WPM in a mesh, which may
     * be not an instance. Comparison: ID, ContentType and Content. They have to be equal.
     * 
     * (wendt)
     *
     ...
     * @return
     */
    private static clsWordPresentationMesh searchInstanceOfDataStructureInWPMImageMeshbyID(
            clsWordPresentationMesh poFindInMesh, clsWordPresentationMesh poFindDataStructure
            )
    {
        ...
        {
            if (poFindDataStructure.getDS_ID() == oMeshWPM.getDS_ID() && poFindDataStructure.getContentType() == oMeshWPM.getContentType()
     ...
     * @return
     */
    private static clsWordPresentationMesh searchInstanceOfDataStructureInWPMImageMeshbyHashCode(
            clsWordPresentationMesh poFindInMesh, clsWordPresentationMesh poFindDataStructure
    )
    {
        clsWordPresentationMesh oResult = clsMeshTools.getNullObjectWPM();
    ...
    public static boolean checkIfWPMImageHasSubImages(
            clsWordPresentationMesh poWPM
        )
    {
    ...
    /**
     * Creates a new AssociationPri between 2 containers and adds this association to the associated data structures. In
     * this way, the match weight between a perceived image and a memory is stored
     * 
     ...
     * @param prWeight
     */
    public static void createAssociationPrimary(
            clsThingPresentationMesh poStructureA, clsThingPresentationMesh poStructureB, double prWeight
    )
    {
        eContentType oContentType = eContentType.ASSOCIATIONPRI;
        clsAssociationPrimary oAssPri = (clsAssociationPrimary) clsDataStructureGenerator.generateASSOCIATIONPRI(oContentType, poStructureA, poStructureB,
                prWeight);
     ...
     * @param prWeight
     * @param pnAddMode:
     *            0 = internal associations, 2
     * @throws Exception
     */
    public static void createAssociationAttribute(
            clsThingPresentationMesh poStructureA, clsThingPresentation poStructureB, double prWeight, int pnAddMode
        ) throws Exception
    {
     ...
     * @param prWeight
     */
    public static void createAssociationTemporary(
            clsThingPresentationMesh poSuperStructure, clsThingPresentationMesh poSubStructure, double prWeight
        )
    {
        eContentType oContentType = eContentType.PARTOFASSOCIATION;
        // Create association
        clsAssociationTime oAssTemp = (clsAssociationTime) clsDataStructureGenerator.generateASSOCIATIONTIME(oContentType, poSuperStructure, poSubStructure,
                prWeight);
     ...
     * @throws Exception
     */
    public static void setUniqueTP(
            clsThingPresentationMesh poTPM, eContentType poTPContentType, String poTPContent
            ) throws Exception
    {
     ...
     * @return
     */
    public static String getUniqueTPoverAssociation(
            clsThingPresentationMesh poTPM, eContentType poTPContentTypeOfAssociation
        )
    {
        String result = "";
    ...
    public static String getUniqueTP(
            clsThingPresentationMesh tpm, eContentType contentTypeOfTP
                    )
    {
        String result = "";
     ...
     * @param poTPContentType
     */
    public static void removeUniqueTP(
            clsThingPresentationMesh poTPM, eContentType poTPContentType
    )
    {
        clsAssociation oAss = clsMeshTools.getUniqueTPAssociation(poTPM, poTPContentType);
     ...
     * @return
     */
    public static clsAssociation getUniqueTPAssociation(
            clsThingPresentationMesh poTPM, eContentType poTPAssociationContentType
        )
    {
    ...
    /**
     * Create a new association secondary between 2 existing objects and add the association to the objects association
     * lists (depending on add state)
     * 
     * (wendt)
     *
     ...
     * @param <E>
     *            WPM or WP
     * @param poElementOrigin
     *            Always a WPM
     * @param nOriginAddAssociationState
     *            0: Do not add, 1: Add to internal associations, 2: Add to external associations
     * @param poElementTarget
     *            WPM or WP
     * @param nTargetAddAssociationState
     *            0: Do not add, 1: Add to internal associations, 2: Add to external associations
     * @param prWeight
     * @param poContenType
     * @param poPredicate
     ...
     */
    public static <E extends clsSecondaryDataStructure> clsAssociationSecondary createAssociationSecondary(
            clsWordPresentationMesh poElementOrigin, int nOriginAddAssociationState, E poElementTarget, int nTargetAddAssociationState, double prWeight,
            eContentType poContentType, ePredicate poPredicate, boolean pbSwapDirectionAB
            )
    {
        ...
        {
            oNewAss = (clsAssociationSecondary) clsDataStructureGenerator.generateASSOCIATIONSEC(poContentType, poElementOrigin, poElementTarget, poPredicate,
                    prWeight);
        }
        else
        {
            oNewAss = (clsAssociationSecondary) clsDataStructureGenerator.generateASSOCIATIONSEC(poContentType, poElementTarget, poElementOrigin, poPredicate,
                    prWeight);
        }
     ...
     * @param poWPContent
     */
    public static void setUniquePredicateWP(
            clsWordPresentationMesh poWPM, eContentType poAssContentType, ePredicate poAssPredicate, eContentType poWPContentType, String poWPContent,
            boolean pbAddToInternalAssociations
            )
    {
        // Get association if exists
     ...
     * @param poWPContent
     */
    public static void setNonUniquePredicateWP(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate, eContentType poWPContentType, String poWPContent, boolean pbAddToInternalAssociations
            )
    {
        // Get association if exists
    ...
    /**
     * Add a WPM with predicate association to another WPM - if the an association with that predicate already exists,
     * use the existing association and replace its end point, if necessary.
     * 
     * (Kollmann)
     *
     ...
     */
    public static void setUniquePredicateWPM(
            clsWordPresentationMesh poOriginWPM, ePredicate poAssPredicate, clsWordPresentationMesh poAddWPM, boolean pbAddToInternalAssociations
                )
    {
        // Get association if exists
     ...
     * @param pbAddToInternalAssociations
     */
    public static void setNonUniquePredicateWPM(
            clsWordPresentationMesh poOriginWPM, ePredicate poAssPredicate, clsWordPresentationMesh poAddWPM, boolean pbAddToInternalAssociations
                )
    {
        // Get association if exists
     ...
     * @param poAssPredicate
     */
    public static void removeAllNonUniquePredicateSecondaryDataStructure(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
    )
    {
        ArrayList<clsDataStructurePA> oAssList = clsMeshTools.searchDataStructureOverAssociation(poWPM, poAssPredicate, 0, true, false);
     ...
     * @return
     */
    public static clsWordPresentation getUniquePredicateWP(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
        )
    {
        // clsWordPresentation oResult = null;

        // clsAssociation oAss = (clsAssociation) clsMeshTools.searchFirstDataStructureOverAssociationWPM(poWPM,
        // poAssPredicate, 0, true);
    ...
    public static clsWordPresentationMesh getUniquePredicateWPM(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
        )
    {
        clsWordPresentationMesh oResult = clsMeshTools.getNullObjectWPM();
     ...
     * @return
     */
    private static ArrayList<clsSecondaryDataStructure> getNonUniquePredicateSecondaryDataStructure(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
    )
    {
     ...
     * @return
     */
    public static ArrayList<clsWordPresentation> getNonUniquePredicateWP(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
    )
    {
        ...
        // ArrayList<clsDataStructurePA> oDSList = clsMeshTools.searchDataStructureOverAssociation(poWPM,
        // poAssPredicate, 0, false, false);
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getNonUniquePredicateWPM(
            clsWordPresentationMesh poWPM, ePredicate poAssPredicate
    )
    {
    ...
    /**
     * Add associations to both elements, if they only exist in one of the elements. This is especially useful at the
     * image associations
     * 
     * (wendt)
     *
     ...
     * @param poInput
     */
    public static void setInverseAssociations(
            clsWordPresentationMesh poInput
                    )
    {
     ...
     */
    public static void setInverseAssociations(
            clsThingPresentationMesh poInput
                    )
    {
        // Go through the associations and search for the other elements in the external associations
        // System.out.println(poInput);
    ...
    /**
     * Remove all associations, which connect 2 images or 2 entities, which are not in the same image. Only entities
     * within the same image can use the associationtemporary. All other shall use association primary
     * 
     * (wendt)
     *
     ...
     * @param poMesh
     */
    public static void removeAllExternalAssociationsTPM(
            clsThingPresentationMesh poMesh
        )
    {
     ...
     * @param poMesh
     */
    public static void removeAllTemporaryAssociationsTPM(
            clsThingPresentationMesh poMesh
        )
    {
        ListIterator<clsAssociation> liList = poMesh.getExternalAssociatedContent().listIterator();
     ...
     * @param mesh
     */
    public static void removeTPMPartOfWPM(
            clsWordPresentationMesh input
                )
    {
     ...
     *
     * @param poSourceTPM:
     *            The object which has the association
     * @param poDeleteObject:
     *            The associatited object, which association shall be deleted.
     */
    public static void deleteAssociationInObject(
            clsThingPresentationMesh poSourceTPM, clsThingPresentationMesh poDeleteObject
            )
    {
     ...
     *            The associatited object, which association shall be deleted.
     */
    public static void removeAssociationInObject(
            clsWordPresentationMesh poSourceWPM, clsSecondaryDataStructure poRootOrLeafDeleteObject
            )
    {
        boolean bFound = false;
        clsAssociation oDeleteAss = null;
     ...
     */
    public static void removeAssociationInObject(
            clsWordPresentationMesh poSourceWPM, ePredicate oPredicateToDelete
    )
    {
     ...
     * @return
     */
    public static clsThingPresentationMesh getSELF(
            clsThingPresentationMesh poImage
    )
    {
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> getAllTPMImages(
            clsThingPresentationMesh poPerceptionalMesh, int pnLevel
        )
    {
        ...
        // oFoundImages.addAll(getDataStructureInTPM(poPerceptionalMesh, eDataType.TPM, oContentTypeRPI, false,
        // pnLevel));
        //
        // //Add all RPA.
        // ArrayList<eContentType> oContentTypeRPA = new ArrayList<eContentType>();
        // oContentTypeRI.add(eContentType.RPA);
        // oFoundImages.addAll(getDataStructureInTPM(poPerceptionalMesh, eDataType.TPM, oContentTypeRPA, false,
        // pnLevel));
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> getAllTPMEntities(
            clsThingPresentationMesh poMesh, int pnLevel
            )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
        ArrayList<clsThingPresentationMesh> oRetVal = new ArrayList<clsThingPresentationMesh>();
    ...
    public static void mergeMesh(
            clsThingPresentationMesh poSourceMesh, clsThingPresentationMesh poNewMesh
                        )
    {
     ...
     * @param poAssociation
     */
    public static void moveAssociation(
            clsThingPresentationMesh poTargetTPM, clsThingPresentationMesh poOriginTPM, clsAssociation poAssociation
            )
    {
    ...
    /**
     * Move all associations, which do not already exist from the origin structure to the target structure. In that way
     * it is possible to merge 2 meshes over the same structure.
     * 
     ...
     * @param poOriginTPM
     */
    public static void moveAllAssociations(
            clsThingPresentationMesh poTargetTPM, clsThingPresentationMesh poOriginTPM
        )
    {
    ...
    /**
     * Delete an object in a mesh. Ony the deleteobject is the input, as the object is deleted as soon as the delete
     * object is not connected to any mesh. All meshes, where this object was present are modified.
     * 
     * (wendt)
     *
     ...
     * @param poDeleteObject
     */
    public static void deleteObjectInMesh(
            clsThingPresentationMesh poDeleteObject
                )
    {
        // In this function the whole tree shall be deleted, of which a structure is connected. Start with the focused
        // element and
        ...
        // Now the object is not connected with anything more and can be seen as deleted from the meshes, which it was
        // connected. It does not matter in which mesh it belongs, everything is deleted
    }
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getAllWPMImages(
            clsWordPresentationMesh poMesh, int pnLevel
        )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getAllWPMObjects(
            clsWordPresentationMesh poMesh, int pnLevel
        )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static ArrayList<clsSecondaryDataStructure> getAllSecondaryDataStructureObjects(
            clsWordPresentationMesh poMesh, int pnLevel
        )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
        ...
        // ArrayList<clsPair<eContentType, String>> oContentTypeAndContentPairRI = new ArrayList<clsPair<eContentType,
        // String>>();
        oContentTypeAndContentPairRI.add(new clsPair<eContentType, String>(eContentType.NOTHING, ""));
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getAllActionsFromWPMImages(
            clsWordPresentationMesh poMesh, int pnLevel
        )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
     ...
     */
    public static void moveAssociation(
            clsWordPresentationMesh poTargetWPM, clsWordPresentationMesh poOriginWPM, clsAssociation poAssociation, boolean removeAfterMove
            )
    {
        // 1. Check if Element A or B has the origin structure
     ...
     */
    public static void mergeMesh(
            clsWordPresentationMesh poSourceMesh, clsWordPresentationMesh poNewMesh
        )
    {
        // Check if both presentations are TPM or WPM. Else nothing is done
        // if (poSourceMesh instanceof clsThingPresentationMesh && poNewMesh instanceof clsThingPresentationMesh) {
    ...
    /**
     * Move all associations from one mesh to another. Only the direct associations are considered. Cases: 1. WPM
     * Association already exists -> Do nothing 2. WP association already exists -> Replace the WP with the new one 3.
     * WP association does not exist -> Move the association 4. WPM association does not already exist -> Find if the
     * other element of the MoveFromMesh in the MoveToMesh. If it exists, move association, if not, do nothing. All new
     * elements will be handled separately
     * 
     * (wendt)
     *
     ...
     */
    private static void moveAllAssociationsMergeMesh(
            clsWordPresentationMesh poMoveToMesh, clsWordPresentationMesh poMoveFromMesh
                        )
    {
        ...
        for (clsAssociation oIntMoveFromAss : poMoveFromMesh.getInternalAssociatedContent())
        {
            ...
            if (bAssExist == false)
            {
                ...
                {
                    // Search the other element in the sourcemesh. If it exists, then change the association, if it does
                    ...
                    {
                        clsWordPresentationMesh oMeshElementWPM = clsMeshTools.searchInstanceOfDataStructureInWPMImageMeshbyID(poMoveToMesh,
                                (clsWordPresentationMesh) oOtherUnknownElement);
                        if (oMeshElementWPM.isNullObject() == false)
                        {
                            // Now, replace the other element of the MoveFromMesh with the found element in the
                            // MoveToMesh
        ...
        for (clsAssociation oExtMoveFromAss : poMoveFromMesh.getExternalAssociatedContent())
        {
            ...
            if (oExtMoveFromAss instanceof clsAssociationSecondary)
            {
                ...
                if (bAssExist == false)
                {
                    ...
                    {
                        // Search the other element in the sourcemesh. If it exists, then change the association, if it
                        ...
                        if (oOtherUnknownElement instanceof clsWordPresentationMesh)
                        {
                            ...
                            if (oMeshElementWPM.isNullObject() == false)
                            {
                                ...
                                // clsLogger.jlog.debug("WPM " + oMeshElementWPM + " in " + oExtMoveFromAss + " moved
                                // from " + poMoveFromMesh + " \n to " + poMoveToMesh);
                            }
                            else
                            {
                        ...
                        else
                        {
                            try
                            {
                                throw new Exception("Only WPM can be addressed here. Object: " + oOtherUnknownElement + "The association " + oExtMoveFromAss
                                        + " does not contain " + poMoveFromMesh);
                            }
                            catch (Exception e)
                            {
                                // TODO (wendt) - Auto-generated catch block
     ...
     */
    private static void addWPMImageToWPMImageMesh(
            clsWordPresentationMesh poMoveToMesh, clsWordPresentationMesh poNewStructure
                    )
    {
        ...
        for (clsAssociation oAss : poNewStructure.getExternalAssociatedContent())
        {
            ...
            {
                // Find in mesh
                clsWordPresentationMesh oOtherElementInMesh = clsMeshTools.searchInstanceOfDataStructureInWPMImageMeshbyID(poMoveToMesh,
                        (clsWordPresentationMesh) oOtherElement);
                // If found, then replace the current other element with the element from the mesh and add the
                // association to the mesh element
     ...
     * @param poNewWPM
     */
    private static void removeAllExternalAssociationsWithSameID(
            clsWordPresentationMesh poOldWPM, clsWordPresentationMesh poNewWPM
        )
    {
     ...
     */
    public static void moveAllAssociations(
            clsWordPresentationMesh poTargetWPM, clsWordPresentationMesh poOriginWPM
        )
    {
    ...
    /**
     * Move all associations, which do not already exist from the origin structure to the taregt structure. In that way
     * it is possible to merge 2 meshes over the same structure
     * 
     ...
     */
    public static void moveAllAssociations(
            clsWordPresentationMesh poTargetWPM, clsWordPresentationMesh poOriginWPM, ArrayList<clsDataStructurePA> poMovedAssociationList,
            ArrayList<clsTriple<clsWordPresentationMesh, clsWordPresentationMesh, clsAssociation>> poTaskList
        )
    {
        ...
        for (clsAssociation oOriAss : poOriginWPM.getInternalAssociatedContent())
        {
            ...
            for (clsAssociation oTarAss : poTargetWPM.getInternalAssociatedContent())
            {
                ...
                if (bFound == true)
                {
                    ...
                    //
                    // if (poMovedAssociationList.contains(OtherOriWPM)==false && OtherOriWPM instanceof
                    // clsWordPresentationMesh && OtherTarWPM instanceof clsWordPresentationMesh) {
                    // clsMeshTools.moveAllAssociations((clsWordPresentationMesh)OtherTarWPM,
                    // (clsWordPresentationMesh)OtherOriWPM, poMovedAssociationList, poTaskList);
                    // }
            ...
            if (bFound == false)
            {
                ...
                // poTaskList.add(new clsTriple<clsWordPresentationMesh, clsWordPresentationMesh,
                // clsAssociation>(poTargetWPM, poOriginWPM, oOriAss));
        ...
        for (clsPair<clsAssociation, clsAssociation> oP : poTaskListInt)
        {
            ...
            if (poMovedAssociationList.contains(OtherOriWPM) == false && OtherOriWPM instanceof clsWordPresentationMesh
                    && OtherTarWPM instanceof clsWordPresentationMesh)
            {
     ...
     * @return
     */
    private static boolean checkAssociationExists(
            clsAssociation poAssA, clsAssociation poAssB
            )
    {
        ...
        else if (poAssA.getDS_ID() == poAssB.getDS_ID() && poAssA.getRootElement().getDS_ID() == poAssB.getRootElement().getDS_ID()
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getOtherInternalImageAssociations(
            clsWordPresentationMesh poImage, ArrayList<clsWordPresentationMesh> poEntityList
                    )
    {
        ArrayList<clsWordPresentationMesh> oRetVal = new ArrayList<clsWordPresentationMesh>();
     ...
     */
    public static void deleteObjectInMesh(
            clsWordPresentationMesh poDeleteObject
            )
    {
        // In this function the whole tree shall be deleted, of which a structure is connected. Start with the focused
        // element and
     ...
     * @return
     */
    public static clsThingPresentationMesh createTPMImage(
            ArrayList<clsThingPresentationMesh> poInput, eContentType poContentType, String poContent
        )
    {
     ...
     *
     * @param poInput:
     *            List of structures, which shall be added
     * @param poMesh:
     *            The image, which shall receive the structures
     */
    public static void addTPMToTPMImage(
            clsThingPresentationMesh oImage, ArrayList<clsThingPresentationMesh> oAddList
    )
    {
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> getAllTPMMemories(
            clsThingPresentationMesh poPerceptionalMesh, int pnLevel
        )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> getAllTPMObjects(
            clsThingPresentationMesh poPerceptionalMesh, int pnLevel
                )
    {
        ArrayList<clsDataStructurePA> oFoundImages = new ArrayList<clsDataStructurePA>();
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> getAllSubTPMFromTPM(
            clsThingPresentationMesh poImage
    )
    {
        ArrayList<clsThingPresentationMesh> oRetVal = new ArrayList<clsThingPresentationMesh>();
    ...
    /**
     * Get a list of all drivemeshes in a certain thing presentation mesh, pnLevel=1 (Only this image) (wendt)
     *
     ...
     * @return
     */
    public static ArrayList<clsAssociationDriveMesh> getAllDMInMesh(
     ...
     * @return
     */
    public static ArrayList<clsAssociationDriveMesh> getSelectedDMInImage(
            clsThingPresentationMesh poPerceptionalMesh, ArrayList<eContentType> poFilterContentType
        )
    {
        ArrayList<clsAssociationDriveMesh> oRetVal = new ArrayList<clsAssociationDriveMesh>();
     ...
     * @return
     */
    public static ArrayList<clsAssociationEmotion> getAllEmotionsInImage(
            clsThingPresentationMesh poPerceptionalMesh
    )
    {
        ArrayList<clsAssociationEmotion> oRetVal = new ArrayList<clsAssociationEmotion>();
        ...
        for (clsAssociation oAss : poPerceptionalMesh.getInternalAssociatedContent())
        {
            ...
            {
                oFoundList.addAll(
                        getDataStructureInTPM((clsThingPresentationMesh) oAss.getLeafElement(), eDataType.EMOTION, new ArrayList<eContentType>(), false, 1));
            }
        }
    ...
    /**
     * Filter a list of TPMs for certain content and content type. NULL counts as nothing and is not used as filter
     * criterium
     * 
     * (wendt)
     *
     ...
     * @return
     */
    public static ArrayList<clsThingPresentationMesh> filterTPMList(
            ArrayList<clsThingPresentationMesh> poMeshList, String poContentType, String poContent, boolean bStopAtFirstMatch
            )
    {
        ArrayList<clsThingPresentationMesh> oRetVal = new ArrayList<clsThingPresentationMesh>();
        ...
        for (clsThingPresentationMesh oTPM : poMeshList)
            ...
            {
                if ((poContentType.equals(oTPM.getContentType()) == true) && (poContent.equals(oTPM.getContent()) == true))
                {
                    oRetVal.add(oTPM);
    ...
    public static clsWordPresentationMesh createWPMImage(
            ArrayList<clsSecondaryDataStructure> poInput, eContentType poContentType, String poContent
        )
    {
     ...
     *            The image, which shall receive the structures
     */
    public static void addSecondaryDataStructuresToWPMImage(
            clsWordPresentationMesh oImage, ArrayList<clsSecondaryDataStructure> oAddList
            )
    {
        // Modify the image by adding additional compontents
    ...
    /**
     * Get the super structure of a data structure. If the input is its own super structure, then return itself.
     * 
     * (wendt)
     *
     ...
     * @return
     */
    public static clsWordPresentationMesh getSuperStructure(
            clsWordPresentationMesh poInput
        )
    {
     ...
     * @return
     */
    public static ArrayList<clsWordPresentationMesh> getAllSubWPMInWPMImage(
            clsWordPresentationMesh poImage
            )
    {
        ArrayList<clsWordPresentationMesh> oRetVal = new ArrayList<clsWordPresentationMesh>();
     ...
     * @return
     */
    public static clsWordPresentationMesh getSELF(
            clsWordPresentationMesh poImage
                )
    {
        clsWordPresentationMesh oRetVal = null;
    ...
    public static clsWordPresentationMesh createImageFromEntity(
            clsWordPresentationMesh poEntity, eContentType poImageContentType
        )
    {
        ...
        clsAssociationWordPresentation oAssWP = (clsAssociationWordPresentation) clsDataStructureGenerator.generateASSOCIATIONWP(eContentType.ASSOCIATIONWP,
                oResult, oTPMImage, 1.0);
