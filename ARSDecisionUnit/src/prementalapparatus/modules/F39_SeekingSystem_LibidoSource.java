 ...
 * 
 * @author deutsch 03.03.2011, 15:16:06
 */
...
/**
 * The seeking system is the basic motivational system. {E39} is collecting information on libido produced by various
 * inner somatic sources as well as by erogenous zones.
 * 
 * @author muchitsch 07.05.2012, 15:16:06
 * 
 */
        ...
        implements I0_1_receive, I0_2_receive, I1_1_send, itfInspectorGenericTimeChart
{
     ...
     * basic constructor
     * 
     * @author muchitsch 03.03.2011, 15:42:22
     *
     * @param poPrefix
     * @param poProp
     * @param poModuleList
     * @throws Exception
     */
    public F39_SeekingSystem_LibidoSource(
    ...
    ) throws Exception
    {
        ...
        libidoImpactFactor = poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_LIBIDO_IMPACT_FACTOR).getParameterDouble();
     ...
     * (non-Javadoc)
     *
     * @author deutsch 03.03.2011, 15:38:54
     * 
     * @see pa.interfaces.send._v38.I1_8_send#send_I1_8(java.util.HashMap)
     */
    @Override
    public void send_I1_1(
            double prData, clsDataContainer poData
            )
    {
     ...
     */
    @Override
    public void receive_I0_2(
            clsDataContainer poData
            )
    {
     ...
     * (non-Javadoc)
     *
     * @author deutsch 15.04.2011, 20:08:09
     * 
     ...
     * (non-Javadoc)
     *
     * @author deutsch 19.04.2011, 10:39:30
     * 
