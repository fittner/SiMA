                ...
                while (liSubList.hasNext()) {
                    ...
                    if (oFirstAss.getRootElement().equals(oSecondAss.getRootElement()) && (oSecondAss instanceof clsAssociationDriveMesh) && (oSecondAssPair.b == false)) {   
                        ...
                        if (oFirstDM.getDriveIdentifier().equals(oSecondDM.getDriveIdentifier())==true) {
                            ...
                            log.error("TPM has two or more equivalent drive meshes associated that will be merged. This should only happen if repressed content emerges.\nTPM:\n" + poInput.toString() + "\nDM: " + oFirstDM.toString());
                            
                            //poInput.getExternalAssociatedContent().remove(oSecondAss);
                            //oSecondAss.setAssociationElementA(null);
