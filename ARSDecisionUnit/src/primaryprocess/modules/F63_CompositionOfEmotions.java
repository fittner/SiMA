...
//							}
					...
					//koller Emotionsuebertragung. Hier wirken sich die Emotionen wahrgenommener Bodystates anderer Agenten auf die eigenen Affektbetr�ge aus.
                    ...
                    if ( oEntityAss.getContentType() == eContentType.ASSOCIATIONATTRIBUTE && !(( clsThingPresentationMesh)oPIINtAss.getAssociationElementB()).getContent().equalsIgnoreCase("EMPTYSPACE")   ) {
                        if(oEntityAss.getAssociationElementA().getContentType() == eContentType.ENTITY){
                            ...
                            if(!(oTPMA.getContent().equals("SELF"))){ //koller wenn der bodystate am TPM Self angeh�ngt ist, wird er ignoriert. Es kann duch Entfernen dieses ifs wieder Einfluss bekommen. 
