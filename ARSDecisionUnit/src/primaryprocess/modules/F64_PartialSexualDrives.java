...
/**
 * From F40 comes the newly formed libido and signals of the erogenous zones in form of neuro-symbols are. The newly
 * formed libido is divided (on the basis of personality parameters) on the libido memory the partial drives. With the
 * aid of signals from the erogenous zones, the libido of the partial drive storage is dissipated. The sexual drives are
 * generated from the store of libido instincts.
 * 
 * @author herret Apr 2, 2013, 9:51:18 AM
 * 
 */
public class F64_PartialSexualDrives extends clsModuleBase implements D1_2_send, D1_3_send, D1_4_receive, D1_5_receive,
        I2_1_receive, I3_3_send, itfInspectorGenericDynamicTimeChart
{
    ...
    public F64_PartialSexualDrives(
            ...
            clsPersonalityParameterContainer poPersonalityParameterContainer, DT4_PleasureStorage poPleasureStorage,
            int pnUid
    ) throws Exception
    {
        ...
        moSplitterFactors.put("ORAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_SPLITFACTOR_ORAL).getParameterDouble());
        moSplitterFactors.put("ANAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_SPLITFACTOR_ANAL).getParameterDouble());
        moSplitterFactors.put("GENITAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_SPLITFACTOR_GENITAL).getParameterDouble());
        moSplitterFactors.put("PHALLIC", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_SPLITFACTOR_PHALLIC).getParameterDouble());

        moImpactFactors = new HashMap<String, Double>();
        moImpactFactors.put("ORAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_IMPACT_FACTOR_ORAL).getParameterDouble());
        moImpactFactors.put("ANAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_IMPACT_FACTOR_ANAL).getParameterDouble());
        moImpactFactors.put("GENITAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_IMPACT_FACTOR_GENITAL).getParameterDouble());
        moImpactFactors.put("PHALLIC", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_IMPACT_FACTOR_PHALLIC).getParameterDouble());

        moPersonalitySplitFactors = new HashMap<String, Double>();
        moPersonalitySplitFactors.put("ORAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_PERSONALITY_SPLIT_ORAL).getParameterDouble());
        moPersonalitySplitFactors.put("ANAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_PERSONALITY_SPLIT_ANAL).getParameterDouble());
        moPersonalitySplitFactors.put("GENITAL", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_PERSONALITY_SPLIT_GENITAL).getParameterDouble());
        moPersonalitySplitFactors.put("PHALLIC", poPersonalityParameterContainer
                .getPersonalityParameter("F" + P_MODULENUMBER, P_PERSONALITY_SPLIT_PHALLIC).getParameterDouble());
     ...
     */
    @Override
    public void receive_I2_1(
            Double poLibidoSymbol, HashMap<String, Double> poData
    )
    {
    ...
    {
        // partition of the incoming libido value to all partial drives corresponding to the fixation values
        // (moSplitterFactors)
        log.debug("Before procession F64: " + receive_D1_5().toString());
        // ORAL
        send_D1_2(eDrive.ORAL, new clsPair<Double, Double>(
                moLibidoInput * moSplitterFactors.get("ORAL") * moPersonalitySplitFactors.get("ORAL"),
                moLibidoInput * moSplitterFactors.get("ORAL") * (1 - moPersonalitySplitFactors.get("ORAL"))));
        // ANAL
        send_D1_2(eDrive.ANAL, new clsPair<Double, Double>(
                 moLibidoInput * moSplitterFactors.get("ANAL") * moPersonalitySplitFactors.get("ANAL"),
                 moLibidoInput * moSplitterFactors.get("ANAL") * (1 - moPersonalitySplitFactors.get("ANAL"))));
        // GENITAL
        send_D1_2(eDrive.GENITAL, new clsPair<Double, Double>(
                moLibidoInput * moSplitterFactors.get("GENITAL") * moPersonalitySplitFactors.get("GENITAL"),
                moLibidoInput * moSplitterFactors.get("GENITAL") * (1 - moPersonalitySplitFactors.get("GENITAL"))));
        // PHALLIC
        send_D1_2(eDrive.PHALLIC, new clsPair<Double, Double>(
                moLibidoInput * moSplitterFactors.get("PHALLIC") * moPersonalitySplitFactors.get("PHALLIC"),
                moLibidoInput * moSplitterFactors.get("PHALLIC") * (1 - moPersonalitySplitFactors.get("PHALLIC"))));
        ...
        for (String eType : moErogenousZones_IN.keySet())
        {
            ...
            {
                send_D1_3(eDrive.ORAL,
                        new clsPair<Double, Double>(moErogenousZones_IN.get(eType) * moImpactFactors.get("ORAL"), 0.0));
            }
            else if (eType.equals("ORIFICE_ORAL_LIBIDINOUS_MUCOSA"))
            {
                send_D1_3(eDrive.ORAL,
                        new clsPair<Double, Double>(0.0, moErogenousZones_IN.get(eType) * moImpactFactors.get("ORAL")));
            }
        ...
        /*
         * double after=0.0; for(clsPair<Double,Double> oDriveValues: receive_D1_5().values()){ after += oDriveValues.a;
         * after += oDriveValues.b; } //moPleasureStorage.D4_2receive(before - after);
         */

        moOutput = new ArrayList<clsDriveMesh>();

        // generation of the drives corresponding to the libido buffer types
        clsDriveMesh oAADM = CreateDriveRepresentations(eOrgan.LIBIDO, eOrifice.RECTAL_MUCOSA,
                eDriveComponent.AGGRESSIVE, ePartialDrive.ANAL);
        oAADM.setQuotaOfAffect(receive_D1_4(eDrive.ANAL).a);
        moOutput.add(oAADM);
        clsDriveMesh oLADM = CreateDriveRepresentations(eOrgan.LIBIDO, eOrifice.RECTAL_MUCOSA,
                eDriveComponent.LIBIDINOUS, ePartialDrive.ANAL);
        ...
        clsDriveMesh oAGDM = CreateDriveRepresentations(eOrgan.LIBIDO, eOrifice.MALE_GENITAL,
                eDriveComponent.AGGRESSIVE, ePartialDrive.GENITAL);
        oAGDM.setQuotaOfAffect(receive_D1_4(eDrive.GENITAL).a);
        moOutput.add(oAGDM);
        clsDriveMesh oLGDM = CreateDriveRepresentations(eOrgan.LIBIDO, eOrifice.MALE_GENITAL,
                eDriveComponent.LIBIDINOUS, ePartialDrive.GENITAL);
        ...
        for (clsDriveMesh oDriveMeshEntry : moOutput)
        {
            ...
            log.debug("oDriveMeshEntry {}", oDriveMeshEntry.getQuotaOfAffect());
        }
    ...
    private clsDriveMesh CreateDriveRepresentations(
            eOrgan poOrgan, eOrifice poOrifice, eDriveComponent oComponent, ePartialDrive oPartialDrive
    )
    {
        ...
        try
        {
            ...
            clsThingPresentationMesh oOrganTPM = (clsThingPresentationMesh) clsDataStructureGenerator
                    .generateDataStructure(eDataType.TPM,
                            new clsTriple<eContentType, ArrayList<clsThingPresentation>, Object>(eContentType.ORGAN,
                                    new ArrayList<clsThingPresentation>(), oOrgan));
            ...
            clsThingPresentationMesh oOrificeTPM = (clsThingPresentationMesh) clsDataStructureGenerator
                    .generateDataStructure(eDataType.TPM,
                            new clsTriple<eContentType, ArrayList<clsThingPresentation>, Object>(eContentType.ORIFICE,
                                    new ArrayList<clsThingPresentation>(), oOrifice));

            // create the DM
            oDriveCandidate = (clsDriveMesh) clsDataStructureGenerator.generateDM(
                    new clsTriple<eContentType, ArrayList<clsThingPresentationMesh>, Object>(
                            eContentType.DRIVEREPRESENTATION, new ArrayList<clsThingPresentationMesh>(), ""),
     ...
     */
    @Override
    public void send_D1_2(
            eDrive peType, clsPair<Double, Double> oValues
    )
    {
     ...
     */
    @Override
    public clsPair<Double, Double> receive_D1_4(
            eDrive oDrive
    )
    {
