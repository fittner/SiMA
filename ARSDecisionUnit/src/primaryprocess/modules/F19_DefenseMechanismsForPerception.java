 ...
 * - not yet implemeted (ist auch nicht im Funktionsmodell vorgesehen, w�re aber leicht zu implementieren): isolation (Isolierung) Isolierung trennt den Affektbetrag vom Wahrnehmungsinhalt
 * 
...
public class F19_DefenseMechanismsForPerception extends clsModuleBaseKB implements 
	...
	public F19_DefenseMechanismsForPerception(String poPrefix, clsProperties poProp,
        ...
        // (normalerweise wird sie �ber receive_I5_22 empfangen - siehe vorletzte Zeile in diesem File)
    ...
    private void selectAndActivateDefenseMechanisms() {
        ...
        // conflictTension <= 0.5
            ...
            if (moEgoStrength <= 0.3) {
                         ...
                         // Einfach das Thing presentation and das andere Objekt als Assoziation dranh�ngen und beim origianlobjekt l�schen.
