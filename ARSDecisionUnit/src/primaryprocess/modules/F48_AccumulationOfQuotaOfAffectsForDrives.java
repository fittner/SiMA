 ...
 * 
 * @author muchitsch 02.05.2011, 15:47:11
 */
...
/**
 * F48 combines Libido and homeostatic drive candidates, calculates the first quota of effect based on a splitter
 * mechanism and outputs the result to a list of drive candidates.
 * 
 * @author muchitsch 07.05.2012, 15:47:11
 */
        ...
        implements I3_3_receive, I3_4_receive, I4_1_send, itfInspectorGenericDynamicTimeChart
{
     ...
     * mechanism and outputs the result to a list of drive candidates.
     * 
     * @author muchitsch 02.05.2011, 15:48:57
     *
     * @param poPrefix
     * @param poProp
     * @param poModuleList
     ...
     * @throws Exception
     */
    public F48_AccumulationOfQuotaOfAffectsForDrives(
            String poPrefix, clsProperties poProp, HashMap<Integer, clsModuleBase> poModuleList,
            SortedMap<eInterfaces, ArrayList<Object>> poInterfaceData, DT4_PleasureStorage poPleasureStorage,
            DT1_PsychicIntensityBuffer poLibidoBuffer, clsPersonalityParameterContainer poPersonalityParameterContainer,
            DT3_PsychicIntensityStorage poDT3_IntensityStorage, int pnUid
            ) throws Exception
    {
     ...
     * @since 21.08.2014 15:51:31
     * 
     * @param moPsychicIntensityStorage
     *            the moPsychicIntensityStorage to set
     */
    public void setMoPsychicIntensityStorage(
            DT3_PsychicIntensityStorage moPsychicIntensityStorage
    )
    {
     ...
     * @since 21.08.2014 15:51:31
     * 
     * @param mnPsychicIntensityPleasure
     *            the mnPsychicIntensityPleasure to set
     */
    public void setMnPsychicIntensityPleasure(
            double mnPsychicIntensityPleasure
    )
    {
        ...
        )
    {
        ...
        for (Map.Entry<eDrive, clsPair<Double, Double>> oEntry : moDriveBuffer.entrySet())
        {
            try
            {
                moAllDriveComponents_OUT
                        .add(CreateDriveCandidate(oEntry.getKey(), oEntry.getValue().a, eDriveComponent.AGGRESSIVE));
                moAllDriveComponents_OUT
                        .add(CreateDriveCandidate(oEntry.getKey(), oEntry.getValue().b, eDriveComponent.LIBIDINOUS));
            }
            catch (Exception e)
            {
    ...
    private clsDriveMesh CreateDriveCandidate(
            eDrive poDrive, double rTension, eDriveComponent peComponent
            ) throws Exception
    {
        ...
        clsThingPresentationMesh oOrganTPM = (clsThingPresentationMesh) clsDataStructureGenerator.generateDataStructure(
                eDataType.TPM, new clsTriple<eContentType, ArrayList<clsThingPresentation>, Object>(eContentType.ORGAN,
                        new ArrayList<clsThingPresentation>(), oOrgan.toString()));
        ...
        )
    {
        ...
        // set the actual drive list to DT4, this automatically calculates the pleasure and this value can the be used
        // everywhere
        ...
        logger.clsLogger.getLog("NeutralizedIntensity")
                .debug("ProcessPleasureCalculation::mnPsychicIntensityPleasure = "
                        + Double.toString(mnPsychicIntensityPleasure));

        log.debug("ProcessPleasureCalculation::mnPsychicIntensityPleasure = "
                + Double.toString(mnPsychicIntensityPleasure));
    }
        ...
        )
    {
        ...
        if (moAllDrivesLastStep != null && !moAllDrivesLastStep.isEmpty())
        {
            ...
            for (clsDriveMesh oOldDMEntry : moAllDrivesLastStep)
            {
                ...
                for (clsDriveMesh oNewDMEntry : moAllDriveComponents_OUT)
                {
                            ...
                            oOldDMEntry.getDriveComponent() == oNewDMEntry.getDriveComponent())
                    {
                        ...
                        {
                            // check if DM has an connection to drive aim and drive object
                            if (  oNewDMEntry.getActualDriveObject() == oOldDMEntry.getActualDriveObject()
                               && oNewDMEntry.getActualDriveAim() == oOldDMEntry.getActualDriveAim()
                               )
                            {
                                oNewDMEntry.setQuotaOfAffect(deltaQuotaOfAffect);
                            }
                            else
                            {
                                // Connect received image with drive mesch
                            }
                        }
                    }
                }
        ...
        this.moAllDrivesLastStep = moAllDriveComponents_OUT;
    }
     ...
     * @param poDriveList
     */
    private void AddDebugInfoForUsProgrammers(
    ...
    {
        moDescription = "F48 combines Libido and homeostatic drive candidates, calculates the first quota of effect "
                + "based on a splitter mechanism and outputs the result to a list of drive candidates.";
    }

    /*
     * (non-Javadoc)
     *
     * @author zeilinger 04.05.2011, 08:57:33
     * 
     * @see pa._v38.interfaces.modules.I4_1_send#send_I4_1(java.util.ArrayList)
     */
    @Override
    public void send_I4_1(
