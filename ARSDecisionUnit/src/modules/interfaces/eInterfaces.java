...
public enum eInterfaces {
	...
	D1_3("Write decrease to libido storage (from F39)."),
...
//	I2_19("Thing presentations and their quota of affects are transported from F44 to F6, F7, and F9."), //TD 2011/07/12 - deprecated and unused
	...
	I5_16("Analogous to I5.17, I5.16 transports quota of affects which have formerly been attached to thing presentations representing perceived contents. They are forwarded from F19 to F71.	"),
	I5_17("Transports quota of affects which have originally been attached to thing presentations representing drive contents from F6 to F71. The splitting apart is a result of the defense mechanisms."),
	...
	I5_21("F63 to F55."),
	I5_22("Super Ego Strength form F56 to F6 and F19"),
	I5_23("Transports the extended emotions, the wording context and the quota of affects which have originally been attached to thing presentations representing drive contents from F71 to F20. The splitting apart is a result of the defense mechanisms."),
