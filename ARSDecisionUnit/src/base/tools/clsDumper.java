 ...
 * CHANGELOG
 *
 * 27.03.2012 brandstaetter - File created
 *
 */
package base.tools;
...
public class clsDumper {
    private static clsDumper instance = new clsDumper();

    protected static clsDumper getInstance() {
        return instance;
    }
    ...
    public static String dump(Object o, int maxDepth, int maxArrayElements, String[] ignoreList) {
        DumpContext ctx = clsDumper.getInstance().new DumpContext();
