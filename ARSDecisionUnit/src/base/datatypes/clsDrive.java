...
public class clsDrive {
     ...
     */
    protected clsDriveMesh moDriveMesh;
     ...
     */
    public clsDrive() {
        moDriveMesh = new clsDriveMesh(new clsTriple<Integer, eDataType, eContentType>(1, eDataType.CONCEPT, eContentType.UNDEFINED),
                new ArrayList<clsAssociation>(), 0, "", null, null);
     ...
     */
    public clsDriveMesh returnContent() {
        return moDriveMesh;
    }
    ...
    public boolean isEmpty() {
        if (moConceptEntities == null && moDriveMesh == null) {
            return true;
        }
        if (moConceptEntities.isEmpty()
                && (moDriveMesh.isNullObject() || moDriveMesh.getExternalAssociatedContent().isEmpty()
                        && moDriveMesh.getExternalAssociatedContent().isEmpty() && moDriveMesh.getInternalAssociatedContent().isEmpty())) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((moDriveMesh == null) ? 0 : moDriveMesh.hashCode());
        return result;
    }
    ...
    public boolean equals(final Object poObj) {
        ...
        if (moDriveMesh == null) {
            if (other.moDriveMesh != null) {
                return false;
            }
        } else if (!moDriveMesh.equals(other.moDriveMesh)) {
            return false;
        }
        return true;
    }
    ...
    public class clsEntity {
        ...
        private clsDrive getOuterType() {
            return clsDrive.this;
        }
