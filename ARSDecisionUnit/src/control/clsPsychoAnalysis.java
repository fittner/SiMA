...
//			break; 
			case v38:
				oProp.putAll( control.clsProcessor.getDefaultProperties(pre+P_PROCESSOR) );
...
//		} else {
			moProcessor = new control.clsProcessor(pre+P_PROCESSOR, poProp, uid, poSearchSpace, poMemory);
//		}
