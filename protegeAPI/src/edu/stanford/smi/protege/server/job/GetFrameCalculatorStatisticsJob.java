...
public class GetFrameCalculatorStatisticsJob extends ServerJob {
	   
	private static final long serialVersionUID = 1218145961291562140L;

	private String projectName;
	
	public GetFrameCalculatorStatisticsJob(RemoteServer server, RemoteSession session, String projectName) {
    ...
    public Object run() throws ProtegeException {
        ...
        synchronized (server) {
            ...
            return serverFs.getFrameCalculator().getStats();
		}
    }
