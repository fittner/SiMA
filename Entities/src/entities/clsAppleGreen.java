 ...
 * 
 */
public class clsAppleGreen extends clsInanimate implements itfGetFlesh, itfAPEatable, itfAPCarryable, itfGetBody, itfIsConsumeable {
...
//		String pre = clsProperties.addDot(poPrefix);
	...
	public static clsProperties getDefaultProperties(String poPrefix) {
		...
		oProp.setProperty(pre+P_SHAPE+"."+P_SHAPENAME+"."+clsShape2DCreator.P_IMAGE_PATH, "/ARSIN/src/resources/images/AppleGreen.png");
