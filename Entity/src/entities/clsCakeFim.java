 ...
 * 
 */
public class clsCakeFim extends clsOrganic implements itfGetFlesh, itfAPEatable, itfAPCarryable, itfGetBody, itfIsConsumeable, itfAPDivideable {
	public static final String CONFIG_FILE_NAME ="cakefim.default.properties";
	
	private boolean mnDestroyed = false;
	
	public final clsProperties moCreationProperties;
	
	public clsCakeFim(String poPrefix, clsProperties poProp, int uid)
    {
...
//		String pre = clsProperties.addDot(poPrefix);
	...
	public static clsProperties getDefaultProperties(String poPrefix) {
		...
		oProp.setProperty(pre+P_SHAPE+"."+P_SHAPENAME+"."+clsShape2DCreator.P_IMAGE_PATH, clsGetARSPath.getRelativImagePath() + "cake.png");
	...
	protected void setEntityType() {
		meEntityType = eEntityType.CAKEFIM;
	...
	public void updateInternalState() {
		...
		if (getFlesh().getTotallyConsumed() && !mnDestroyed) {
			mnDestroyed = true;
			//This command removes the cakefim from the playground
	...
	public void devide(double pfSplitFactor){
		clsCakeFim oNewEntity= (clsCakeFim)dublicate(moCreationProperties,0,pfSplitFactor);
