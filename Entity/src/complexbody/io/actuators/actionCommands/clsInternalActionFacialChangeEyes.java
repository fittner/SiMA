...
public class clsInternalActionFacialChangeEyes extends clsInternalActionCommand {

	private ArrayList<Double> moStorageOfEmotionIntensities = null;
	private ArrayList<String> moStorageOfEmotionNames = null;
	
	public clsInternalActionFacialChangeEyes(ArrayList<Double> poStorageOfEmotionIntensities, ArrayList<String> poStorageOfEmotionNames) {
