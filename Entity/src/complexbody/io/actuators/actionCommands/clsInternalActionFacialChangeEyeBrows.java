...
public class clsInternalActionFacialChangeEyeBrows extends clsInternalActionCommand {

	private ArrayList<Double> moStorageOfEmotionIntensities = null;
	private ArrayList<String> moStorageOfEmotionNames = null;
	
	public clsInternalActionFacialChangeEyeBrows(ArrayList<Double> poStorageOfEmotionIntensities, ArrayList<String> poStorageOfEmotionNames) {
