...
public class clsInternalActionFacialChangeMouth extends clsInternalActionCommand {

	private ArrayList<Double> moStorageOfEmotionIntensities = null;
	private ArrayList<String> moStorageOfEmotionNames = null;
	
	public clsInternalActionFacialChangeMouth(ArrayList<Double> poStorageOfEmotionIntensities, ArrayList<String> poStorageOfEmotionNames) {
