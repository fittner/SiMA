 ...
 * 
 */
public class clsInternalActionAffectHeartBloodPressureDiastolic extends clsInternalActionCommand {
	
	private double mrIntensity = -1;
	
	private eInternalActionIntensity meInternalActionIntensity;
	
	public clsInternalActionAffectHeartBloodPressureDiastolic(double prIntensity) {
