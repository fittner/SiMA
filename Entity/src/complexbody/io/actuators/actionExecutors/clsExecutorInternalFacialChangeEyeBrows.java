...
public class clsExecutorInternalFacialChangeEyeBrows extends clsInternalActionExecutor{
	...
	public clsExecutorInternalFacialChangeEyeBrows(String poPrefix, clsProperties poProp, clsEntity poEntity) {
	...
	protected void setName() {
		moName="Facial eye brows change executor";	
	}
	...
	public boolean execute(clsInternalActionCommand poCommand) {
		...
		clsInternalActionFacialChangeEyeBrows oCommand =(clsInternalActionFacialChangeEyeBrows) poCommand; 
		...
		// Affect the body
		oBody.getIntraBodySystem().getFacialExpression().getBOFacialEyeBrows().affectEyeBrows( oCommand.getStorageOfEmotionIntensities(), oCommand.getStorageOfEmotionNames() );
