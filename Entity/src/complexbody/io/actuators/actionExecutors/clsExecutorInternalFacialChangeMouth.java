...
public class clsExecutorInternalFacialChangeMouth extends clsInternalActionExecutor{
	...
	public clsExecutorInternalFacialChangeMouth(String poPrefix, clsProperties poProp, clsEntity poEntity) {
	...
	protected void setName() {
		moName="Facial mouth change executor";	
	}
	...
	public boolean execute(clsInternalActionCommand poCommand) {
		...
		clsInternalActionFacialChangeMouth oCommand =(clsInternalActionFacialChangeMouth) poCommand; 
		...
		// 1. Affect the body
		oBody.getIntraBodySystem().getFacialExpression().getBOFacialMouth().affectMouth( oCommand.getStorageOfEmotionIntensities(), oCommand.getStorageOfEmotionNames() );
