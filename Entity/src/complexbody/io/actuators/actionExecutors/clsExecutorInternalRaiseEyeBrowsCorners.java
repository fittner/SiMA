 ...
 * CHANGELOG
 *
 * Sep 5, 2014 volkan - File created
 *
 */
 ...
 * 
 * @author volkan
 * Sep 5, 2014, 5:44:22 PM
 * 
 */
public class clsExecutorInternalRaiseEyeBrowsCorners extends clsInternalActionExecutor {
	 ...
	 * @param poProp
	 */
	public clsExecutorInternalRaiseEyeBrowsCorners(String poPrefix, clsProperties poProp, clsEntity poEntity) {
	...
	protected void setName() {
		// TODO (volkan) - Auto-generated method stub
		moName="Raise Eye Brow Corners executor";
	}
	...
	public boolean execute(clsInternalActionCommand poCommand) {
		...
		clsInternalActionRaiseEyeBrowsCorners oCommand =(clsInternalActionRaiseEyeBrowsCorners) poCommand;
		
		// 1. Affect the body
		oBody.getIntraBodySystem().getFacialExpression().getBOFacialEyeBrows().changeEyeBrowsCorners( oCommand.getEyeBrowsCornersRaise() );
