...
public class clsFillLevel extends clsContentColumn {
	 ...
	 */
	public clsFillLevel(double prContent, double prMaxContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun {
	 ...
	 */
	public clsFillLevel(double prContent, double prMaxContent, double prChange) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun {
		super(prContent, prMaxContent);
	 ...
	 */
	public clsFillLevel(double prContent, double prMaxContent, double prChange, double prLowerBound, double prUpperBound) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun {
		super(prContent, prMaxContent);
		mrChange = prChange;		
	 ...
	 */
	public void update() throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun {
		change(mrChange);
	}
