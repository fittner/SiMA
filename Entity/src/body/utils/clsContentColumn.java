...
public class clsContentColumn {
	 ...
	 * @param prMaxContent
	 */
	public clsContentColumn(double prContent, double prMaxContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
		super();
	 ...
	 */
	private void checkValue() throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun {
		double rTempContent = mrContent;
		
		if (this.mrContent < 0.0f) {
			this.mrContent = 0.0f;
			throw new utils.exceptions.exContentColumnMinContentUnderrun(rTempContent, 0.0);
		} else if (this.mrContent > this.mrMaxContent) {
			this.mrContent = this.mrMaxContent;
			throw new utils.exceptions.exContentColumnMaxContentExceeded(rTempContent, mrMaxContent);
		}
	}
	 ...
	 */
	public double increase(double prContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
	 ...
	 * @return the resulting content after checkValue has been executed
	 */
	public double change(double prContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
	 ...
	 * @return the resulting content after checkValue has been executed
	 */
	public double decrease(double prContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
		return this.setContent( this.getContent() - prContent );
	}
	 ...
	 * @return the resulting content after checkValue has been executed
	 */
	public double setContent(double prContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
	 ...
	 * @return the resulting content after checkValue has been executed
	 */
	public double setMaxContent(double prMaxContent) throws utils.exceptions.exContentColumnMaxContentExceeded, utils.exceptions.exContentColumnMinContentUnderrun  {
