 ...
 */
public class FastCircleView extends FastVertexView {
	...
	/**
	 * Constructs a fast circle view associated this view with the specified
	 * cell
	 * @param cell the model cell to associated this view with
	 */
	public FastCircleView(Object cell) {
		super(cell);
	}
