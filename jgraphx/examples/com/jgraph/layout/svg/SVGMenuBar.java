/*
 * $Id: SVGMenuBar.java,v 1.1 2009/09/25 15:17:49 david Exp $
...
public class SVGMenuBar extends JMenuBar {
	...
	public SVGMenuBar(final SVGExample app, JGraphGraphFactory factory) {
		...
		fileMenu.addSeparator();
		fileMenu.add(new JMenuItem(new AbstractAction("Export to SVG") {
			public void actionPerformed(ActionEvent e) {
				app.exportSVG();
			}
		}));
