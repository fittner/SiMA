	...
	public static TabbedInspector getInspector(Inspector poSuperInspector, LocationWrapper poWrapper, GUIState poState, itfDecisionUnit poItfDU)
	{
        ...
        if( poDU instanceof clsDumbMindA) {
        	...
        	if(clsPsychoAnalysis.isUseOldModel())
        	{
            	...
            	oRetVal.addInspector( new inspectors.mind.pa._v19.clsMemoryInspectorTab(poSuperInspector, poWrapper, poState, (clsPsychoAnalysis) poDU), "PA-Memory"); //shows a tab with the memory inspector, mapping for the tree etc see clsInspectorMappingPA
         	}
        	else
        	{
            	...
            	oRetVal.addInspector( new inspectors.mind.pa._v30.clsMemoryInspectorTab(poSuperInspector, poWrapper, poState, (clsPsychoAnalysis) poDU), "PA-Memory"); //shows a tab with the memory inspector, mapping for the tree etc see clsInspectorMappingPA
        	}
...
//       }
        ...
        oRetVal.addInspector( new clsInspectorActionCommands(poSuperInspector, poWrapper, poState, poDU), "Action Commands");        
