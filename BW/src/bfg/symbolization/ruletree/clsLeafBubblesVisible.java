...
import bw.utils.enums.deprecated.enumTypeCount;
...
class clsLeafBubblesVisible extends clsRuleTreeLeaf
{
  ...
  //---------------------------------------------------------------------------
  {
    ...
    if( compare( poImage.moVisionEntitiesList, poBrainsIdentity ) )
    {
  ...
  //---------------------------------------------------------------------------
  public boolean compare(clsContainerPercVisionsEntities poVisionList, clsIdentity poIdentity)
  //---------------------------------------------------------------------------
  {
