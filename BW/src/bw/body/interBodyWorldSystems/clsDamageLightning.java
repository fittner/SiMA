...
public class clsDamageLightning implements itfStep {
	...
	public clsDamageLightning(String poPrefix, clsBWProperties poProp, clsHealthSystem poHealthSystem, clsFastMessengerSystem poFastMessengerSystem, clsSlowMessengerSystem poSlowMessengerSystem) {
	...
	public void lightend(eBodyParts poSource, double prForce) {
		hurt(prForce);
