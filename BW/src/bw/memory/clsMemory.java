...
import bw.LocalizationOrientation.clsStep;
...
/**
 * The main class of the package pkgMemory. It provides the interfaces (Store API, Retrieve API) to use the fundamental memory functionalities $Revision: 682 $:  Revision of last commit $Author: deutsch $: Author of last commit $Date: 2007-07-11 16:48:22 +0200 (Mi, 11 Jul 2007) $: Date of last commit
 */
