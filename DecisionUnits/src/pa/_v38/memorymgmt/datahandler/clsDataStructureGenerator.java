...
public abstract class clsDataStructureGenerator {
	...
	public static clsWordPresentationMesh generateWPM(clsPair <String, Object> poContent, ArrayList<clsAssociation> poAssociations){
		String oContentType = poContent.a; 
		String oContent = (String)poContent.b;
		clsWordPresentationMesh oRetVal = new clsWordPresentationMesh(new clsTripple<Integer, eDataType, String>(setID(), eDataType.WP, oContentType), poAssociations, oContent); 
		return oRetVal;
	}
...
//		}
	...
	public static clsAssociation generateASSOCIATIONSEC(String poContentType, 
		...
		oRetVal = new clsAssociationSecondary(new clsTripple<Integer, eDataType, String>(setID(), eDataType.ASSOCIATIONSEC, oContentType), (clsSecondaryDataStructure)poRoot, (clsSecondaryDataStructure)poLeaf, poPredicate);
		oRetVal.setMrWeight(prWeight);
