...
public class F47_ConversionToPrimaryProcess extends clsModuleBase implements itfMinimalModelMode, I6_9_receive, I5_19_send {
	...
	protected void send() {
		if (mnMinimalModel) {
			send_I5_19(new ArrayList<clsPrimaryDataStructureContainer>());
		} else {
			send_I5_19(new ArrayList<clsPrimaryDataStructureContainer>());
		}
	...
	public void send_I5_19(
		...
		((I5_19_receive)moModuleList.get(46)).receive_I5_19(poGrantedPerception);
		putInterfaceData(I5_19_send.class, poGrantedPerception);
	}
