...
public class F21_ConversionToSecondaryProcessForPerception extends
	...
	public String stateToTEXT() {
		...
		// text += toText.listToTEXT("moAssociatedMemories_IN",
		// moAssociatedMemories_IN);
		// text += toText.listToTEXT("moAssociatedMemoriesSecondary_OUT",
		// moAssociatedMemoriesSecondary_OUT);
		// text += toText.valueToTEXT("moEnvironmentalPerception_OUT",
		// moEnvironmentalPerception_OUT);
