 ...
 * - reversal of affect (Affektverkehrung: shifts parts of the quota of affect to the drive with the opposite eDriveComponent (LIBIDINOUS -> AGGRESSIVE or vice versa) 
...
public class F06_DefenseMechanismsForDrives extends clsModuleBase implements 
	...
	private ArrayList<clsPrimaryDataStructure> moQuotasOfAffect_Output = new ArrayList<clsPrimaryDataStructure>();  // separated quotas of affect which are generated while repressing content
	 ...
	 *
	 */
	private void defenseMechanism_Displacement(ArrayList<clsPair<eDriveComponent, eOrgan>> oForbiddenDrives_Input) {
