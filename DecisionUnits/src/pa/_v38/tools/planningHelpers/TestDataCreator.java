...
public class TestDataCreator {
	...
	static public ArrayList<clsPlanFragment> generateTestPlans_AW() {
		...
		// DEPOSIT STONE
		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("MOVE_FORWARD"), new clsImage(eDistance.FAR, eDirection.CENTER,
		    eEntity.STONE), new clsImage(eDistance.MEDIUM, eDirection.CENTER, eEntity.STONE)));

		moAvailablePlanFragments
		    .add(new clsPlanFragment(new clsAct("DEPOSIT"), new clsImage(eDistance.MEDIUM, eDirection.CENTER, eEntity.STONE), new clsImage(
		        eDistance.MEDIUM, eDirection.CENTER, eEntity.STONE)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("DEPOSIT"), new clsImage(eDistance.NEAR, eDirection.MIDDLE_LEFT,
		    eEntity.STONE), new clsImage(eDistance.NEAR, eDirection.MIDDLE_LEFT, eEntity.STONE)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("TURN_LEFT"), new clsImage(eDirection.LEFT, eEntity.STONE), new clsImage(
		    eDirection.MIDDLE_LEFT, eEntity.STONE)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("TURN_LEFT"), new clsImage(eDirection.MIDDLE_LEFT, eEntity.STONE),
		    new clsImage(eDirection.CENTER, eEntity.STONE)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("TURN_RIGHT"), new clsImage(eDirection.RIGHT, eEntity.STONE), new clsImage(
		    eDirection.MIDDLE_RIGHT, eEntity.STONE)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("TURN_RIGHT"), new clsImage(eDirection.MIDDLE_RIGHT, eEntity.STONE),
		    new clsImage(eDirection.CENTER, eEntity.STONE)));

		// SLEEP
		oEntity = eEntity.EMPTYSPACE;
		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDistance.FAR, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.MEDIUM, eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDistance.MEDIUM, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity)));
		...
		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDirection.LEFT, oEntity), new clsImage(
		    eDirection.MIDDLE_LEFT, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDirection.MIDDLE_LEFT, oEntity), new clsImage(
		    eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDirection.RIGHT, oEntity), new clsImage(
		    eDirection.MIDDLE_RIGHT, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SLEEP"), new clsImage(eDirection.MIDDLE_RIGHT, oEntity), new clsImage(
		    eDirection.CENTER, oEntity)));

		// RELAX
		oEntity = eEntity.EMPTYSPACE;
		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDistance.FAR, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.MEDIUM, eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDistance.MEDIUM, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity),
		    new clsImage(eDistance.NEAR, eDirection.CENTER, oEntity)));
		...
		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDirection.LEFT, oEntity), new clsImage(
		    eDirection.MIDDLE_LEFT, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDirection.MIDDLE_LEFT, oEntity), new clsImage(
		    eDirection.CENTER, oEntity)));

		moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("RELAX"), new clsImage(eDirection.RIGHT, oEntity), new clsImage(
		    eDirection.MIDDLE_RIGHT, oEntity)));
		...
		/*
		 * moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SEARCH1"), new clsImage(eEntity.NONE), new clsImage(eDirection.CENTER,
		 * eEntity.CAKE)));
		 * 
		 * moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SEARCH2"), new clsImage(eEntity.NONE), new clsImage(eDirection.RIGHT,
		 * eEntity.CAKE)));
		 * 
		 * moAvailablePlanFragments.add(new clsPlanFragment(new clsAct("SEARCH3"), new clsImage(eEntity.NONE), new clsImage(eDirection.LEFT,
		 * eEntity.CAKE)));
		 */
