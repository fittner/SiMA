 ...
 * 
 */
public class clsMinu1to1 extends clsCloneable implements Serializable {
	...
	private static final long serialVersionUID = 4136585154085106000L;
	  ...
	  public clsMinu1to1(clsMinu1to1 poValue) {
	    set(poValue);
	  }

	    public clsMinu1to1(double prValue) {
		  set(prValue);
	  }  
	  ...
	  public double set(clsMinu1to1 poValue) {
