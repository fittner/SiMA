/**
 * clsDataTypeCreator.java: DecisionUnits - pa._v19.memorymgmt.creator.datatypes
 * 
 * @author zeilinger
 * 11.08.2010, 20:50:42
 */
package pa._v19.memorymgmt.datahandler;
...
public abstract class clsDataStructureGenerator {
	public static clsDataStructurePA generateDataStructure(eDataType peDataType, Object poContent){
		...
		try {
			Class<?> clzz = Class.forName("pa._v19.memorymgmt.datahandler.clsDataStructureGenerator");
