...
public class Bot extends sim.robot2D.Robot implements Steppable, ForceGenerator{
    ...
    public clsGameGrid moGameGrid = new clsGameGrid();
    ...
    public void step(SimState state)
        ...
        reinforcementLearning(position);
    ...
    public void reinforcementLearning(Double2D poPosition)
    {
    	//transforming global position (x and y coordinates) into Grid-Coordinates
    	clsDiscreteLocation oLocation = getDiscreteRowAndColumn(poPosition, HEIGHT, WIDTH);
