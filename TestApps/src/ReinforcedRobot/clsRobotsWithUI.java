...
import java.awt.*;
import javax.swing.*;
public class clsRobotsWithUI extends GUIState{
    ...
    public static void main(String[] args)
        {
        clsRobotsWithUI simRobots = new clsRobotsWithUI();
        Console c = new Console(simRobots);
        c.setVisible(true);
        }
    
    public clsRobotsWithUI() 
        { 
        super(new clsRobots(System.currentTimeMillis())); 
        }
        
    public clsRobotsWithUI(SimState state) 
        { 
        super(state); 
        }
    ...
    public void setupPortrayals()
        ...
        entityPortrayal.setField(((clsRobots)state).fieldEnvironment);
