...
public class clsRobots extends SimState{
	 public double xMin = 0;
	    ...
	    public clsRobots(long seed)
	        {
	        this(seed, 200, 200);
	        }
	        
	    public clsRobots(long seed, int width, int height)
	        {
	    ...
	    public void start()
	        ...
	        for (int i = 0; i < numBots; i++)
	            ...
	            pos = new Double2D(x, y);
	            bot = new clsBot(pos, new Double2D(0, 0));
	            objPE.register(bot);
	            ...
	            clsEffector effector;
	                        
	            pos = new Double2D(x + 12, y + 6);
	            effector = new clsEffector(pos, new Double2D(0, 0), 1, Color.gray);
