...
public class Robots extends SimState{
    ...
    public ObjectGrid2D gridEnvirnoment;
//    public Continuous2D Pfield;
    ...
    void createGrids()
        ...
        gridEnvirnoment= new ObjectGrid2D(width,height);
...
//       Obstacles
        ...
        obstacle = new Obstacle(pos, 5, 40);
        ...
        obstacle = new Obstacle(pos, 40, 5);
        fieldEnvironment.setObjectLocation(obstacle, new sim.util.Double2D(pos.x, pos.y));
        objPE.register(obstacle);
